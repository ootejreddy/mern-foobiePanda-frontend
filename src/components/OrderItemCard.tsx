...
const OrderItemCard = ({ order }: Props) => {
  ...
  //* when the new order has been passed to this component it will remount with useEffect
  useEffect(() => {
  ...
  const {
    ...
    isPending: isOrderStatusChangeLoading,
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-6">
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <Select
            value={orderStatus}
            disabled={isOrderStatusChangeLoading}
